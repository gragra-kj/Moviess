  ...
  return (
    <ScrollView contentContainerStyle={{paddingBottom:30}} className="flex-1 bg-neutral-900 ">
      <View className="w-full">
        <SafeAreaView className={"z-20 w-full flex-row  justify-between items-center pt-4 px-4 absolute  "+topMargin } >
        ...
        <View>
          <Image source={require('../assets/image.png')} style={{width:width,height:height*0.55}}/>
        </View>
        <LinearGradient 
        colors={['transparent','rgba(23,23,23,0.8)','rgba(23,23,23, 1)']} 
        style={{width,height:height*0.40}} 
        start={{x:0.5,y:0}}
        end={{x:0.5,y:1}} className="absolute bottom-0"/>
      </View>
      <View style={{marginTop:-(height*0.09)}} className="space-y-3">
        <Text className="text-white text-center text-3xl font-bold tracking-wider">{movieName}</Text>
        <Text className="text-neutral-400 font-semibold text-base text-center">Release · 2020 · 170 min </Text>
        <View className="flex-row justify-center mx-4 space-x-2">
          <Text className="text-neutral-400 font-semibold text-base">Action · </Text>
          <Text className="text-neutral-400 font-semibold text-base">Thrill · </Text>
          <Text className="text-neutral-400 font-semibold text-base">Comedy · </Text>
          <Text className="text-neutral-400 font-semibold text-base">Action</Text>
        </View>
        <Text className="text-neutral-400 mx-4 tracking-wide">Many years after the reign of Caesar, a young ape goes on a journey that will lead him to question everything he's been taught about the past and make choices that will define a future for apes and humans alike.</Text>
